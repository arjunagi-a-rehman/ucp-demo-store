      ...
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          ...
          <p className="text-sm text-gray-500">
            {clientId ? `"${clientId}" wants to access your account` : "Sign in to authorize this application"}
          </p>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <p className="text-center text-xs text-gray-400">
            By signing in, you authorize this application to act on your behalf via the Universal Commerce Protocol.
          </p>
        </CardContent>
      </Card>
    </div>
